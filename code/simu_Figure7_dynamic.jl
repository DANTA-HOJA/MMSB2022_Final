...
eqsFull = [
    ...
    Dt(B1AR) ~ (OR(r6_W*AND(r6_fact_NE, AND(r6_finhib_B1ARPG, r6_finhib_B1ARPA)), W_b)*max_B1AR - B1AR) / tau_B1AR,
...
#= 
# Parameter Estimates for Figure 7 ( Figure S5 in supplementary material ) ***
# 
# τB1AR = 0.1
# τB1ARPG = 0.611
# τB1ARPA = 287.97
# τPLB = 9.69 -> 0.969
# 
# W(GRK -> B1ARPG) = 0.537 (r8)
# W(PKAC -> B1ARPA) = 0.95 (r22)
# W(PKAC -> PLB) = 0.5947  (r24)
#
# EC50(AC -> cAMP) = 0.5324   (r14)
# EC50(cAMP -> PKAC) = 0.4881 (r17, r19)
# EC50(PKAC -> PLB) = 0.3128  (r24)
=#
...
function affect_1!(integrator)
    ...
    # # test index of parameters
    # print("\n\n")
    # print("NE = $(integrator.u[15])\n")
    # print("tau_B1AR = $(integrator.p[4])\n")
    # print("tau_B1ARPA = $(integrator.p[6])\n")
    # print("tau_B1ARPG = $(integrator.p[8])\n")
    # print("tau_PLB = $(integrator.p[42])\n")
    # print("\n\n")
    # print("r1_W = $(integrator.p[51])\n")
    # print("\n\n")
